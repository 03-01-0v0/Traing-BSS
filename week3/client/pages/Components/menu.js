    ...
    return (
        ...
        <div id={styles["menuToggle"]}>
            ...
            <ul className={styles.tag_ul} id = {styles["menu"]}>
                <li className={[styles.repon_account, styles.tag_li].join(" ")}><i class="material-icons tag_i">account_circle</i><a className={[styles.hover_nactive, styles.tag_a].join(" ")}>Welcom John</a></li>
                ...
                <li clasName={styles.tag_li}><i class="material-icons">history</i><a href="logs" onClick={handleClick} className ={[props.active === "logs" ? styles.active : '', styles.tag_a].join(" ")}>Logs</a></li>
                <li clasName={styles.tag_li}><i class="material-icons">settings</i><a className={styles.tag_a} href="#">Settings</a></li>
            </ul>
        </div>
        </nav>
    );
